...
class CreateCompoundBasicMaterialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('compound_basic_materials', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('compound_basic_materials');
    }
}
